...
">
    ...
    <div class="relative">
        <!-- Main Search Input -->
        <div class="relative bg-white rounded-lg border-2 border-gray-300 focus-within:border-orange-500 transition-all duration-200 shadow-sm">
            <input 
                type="text" 
                ...
                placeholder="Search products, categories, brands, blogs..." 
                class="w-full px-4 py-3 pr-16 text-lg border-0 rounded-lg focus:outline-none focus:ring-0 bg-transparent"
                autocomplete="off"
            >
            ...
            <button 
                wire:click="search"
                class="absolute right-2 top-1/2 -translate-y-1/2 bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-md transition-colors flex items-center">
            ...
            <button 
                ...
                class="absolute right-16 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors"
        ...
        <!-- Search Suggestions Dropdown (Home Depot Style) -->
        <div 
            ...
            class="absolute top-full left-0 right-0 mt-1 bg-white rounded-lg shadow-2xl border border-gray-200 z-50 overflow-hidden"
            style="display: none;">
