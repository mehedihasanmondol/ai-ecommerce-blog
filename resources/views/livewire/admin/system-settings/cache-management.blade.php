    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        @if(!auth()->user()->hasPermission('system.cache'))
            <div class="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4 flex items-start">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-yellow-700 text-sm mt-1">You do not have permission to manage cache. This section is
                        view-only. Contact your administrator to request cache management permissions.</p>
                </div>
            </div>
        @endif
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="border-2 border-gray-200 rounded-lg p-5 hover:border-indigo-300 transition-colors">
                ...
                <button wire:click="clearAppCache" wire:loading.attr="disabled" wire:target="clearAppCache"
                    {{ !auth()->user()->hasPermission('system.cache') ? 'disabled' : '' }}
            ...
            <div class="border-2 border-gray-200 rounded-lg p-5 hover:border-indigo-300 transition-colors">
                ...
                <button wire:click="clearViewCache" wire:loading.attr="disabled" wire:target="clearViewCache"
                    {{ !auth()->user()->hasPermission('system.cache') ? 'disabled' : '' }}
            ...
            <div class="bg-gradient-to-r from-red-50 to-orange-50 border-2 border-red-200 rounded-lg p-5">
                <div class="flex items-start justify-between mb-4">
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Clear application, route, config, view, and optimization
                            caches all at once</p>
                    </div>
                </div>
