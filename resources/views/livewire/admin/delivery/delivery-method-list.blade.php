<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        @if(auth()->user()->hasPermission('delivery-methods.create'))
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if(auth()->user()->hasPermission('delivery-methods.toggle-status'))
                                    <button wire:click="toggleStatus({{ $method->id }})" class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    @if(auth()->user()->hasPermission('delivery-methods.edit'))
                                    ...
                                    @endif
                                    @if(auth()->user()->hasPermission('delivery-methods.delete'))
                                        <button
                                            wire:click="$dispatch('confirm-delete', { id: {{ $method->id }}, name: '{{ $method->name }}' })"
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <span class="text-sm text-gray-500">
                            Showing {{ $methods->firstItem() ?? 0 }} to {{ $methods->lastItem() ?? 0 }} of
