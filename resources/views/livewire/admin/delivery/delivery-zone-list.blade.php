<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        @if(auth()->user()->hasPermission('delivery-zones.create'))
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
        <div class="p-4">
            <div class="flex items-center gap-4">
                ...
                <div class="flex-1">
                    <div class="relative">
                        <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search zones..."
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if(auth()->user()->hasPermission('delivery-zones.toggle-status'))
                                    <button wire:click="toggleStatus({{ $zone->id }})" class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    @if(auth()->user()->hasPermission('delivery-zones.edit'))
                                    ...
                                    @endif
                                    @if(auth()->user()->hasPermission('delivery-zones.delete'))
                                        <button
                                            wire:click="$dispatch('confirm-delete', { id: {{ $zone->id }}, name: '{{ $zone->name }}' })"
