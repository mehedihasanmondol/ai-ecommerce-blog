                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-2">
                                    @if(auth()->user()->hasPermission('blog-tags.edit'))
                                        <button wire:click="toggleStatus({{ $tag->id }})" class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    @endif
                                    @if(!auth()->user()->hasPermission('blog-tags.edit') && !auth()->user()->hasPermission('blog-tags.delete'))
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <span class="text-sm text-gray-500">
                            Showing {{ $tags->firstItem() ?? 0 }} to {{ $tags->lastItem() ?? 0 }} of {{ $tags->total() }}
                            results
                        </span>
                    </div>
                    <div>
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: @entangle('showDeleteModal') }">
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="relative rounded-lg shadow-xl max-w-md w-full p-6 border border-gray-200"
                    ...
                    <p class="text-sm text-gray-500 text-center mb-6">Are you sure you want to delete this tag? This action
                        cannot be undone.</p>
