                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <div class="flex items-center">
                                    @if($category->getImageUrl())
                                        <img src="{{ $category->getThumbnailUrl() ?? $category->getImageUrl() }}"
                                            alt="{{ $category->name }}" class="h-10 w-10 rounded object-cover mr-3">
                                    @else
                                ...
                                @if($category->parent)
                                    <div class="flex flex-col">
                                        ...
                                        @if($category->getParentHierarchyPath())
                                            <span
                                                class="text-xs text-gray-500 mt-1">{{ $category->getParentHierarchyPath() }}</span>
                                        @endif
                                    </div>
                                @else
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-2">
                                    @if(auth()->user()->hasPermission('blog-categories.edit'))
                                        <button wire:click="toggleStatus({{ $category->id }})" class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    @endif
                                    @if(!auth()->user()->hasPermission('blog-categories.edit') && !auth()->user()->hasPermission('blog-categories.delete'))
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: @entangle('showDeleteModal') }">
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="relative rounded-lg shadow-xl max-w-md w-full p-6 border border-gray-200"
                    ...
                    <p class="text-sm text-gray-500 text-center mb-6">Are you sure you want to delete this category? This
