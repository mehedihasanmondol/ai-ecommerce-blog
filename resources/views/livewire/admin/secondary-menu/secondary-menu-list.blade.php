                    ...
                    <tr data-id="{{ $item->id }}" class="hover:bg-gray-50 cursor-move">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @if($item->open_new_tab)
                                <svg class="w-3 h-3 inline text-gray-400 ml-1" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="col-span-2" x-data="{ showCustomInput: @entangle('showCustomColorInput') }">
                                ...
                                <div x-show="showCustomInput" x-transition class="mt-3">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">
                                        ...
                                        Reference: <a href="https://tailwindcss.com/docs/text-color" target="_blank"
                                            class="text-blue-600 hover:underline">Tailwind Colors</a> |
                                        <a href="https://tailwindcss.com/docs/font-weight" target="_blank"
                                            class="text-blue-600 hover:underline">Font Weight</a>
                                    </p>
                                    @error('customColorClass') <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: @entangle('showDeleteModal') }">
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="relative rounded-lg shadow-xl max-w-md w-full p-6 border border-gray-200"
                    ...
                    <p class="text-sm text-gray-500 text-center mb-6">Are you sure you want to delete this menu item? This
