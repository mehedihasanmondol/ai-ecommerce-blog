            ...
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer"
                        ...
                        ID @if($sortBy === 'id')<i
                        class="fas fa-sort-{{ $sortOrder === 'asc' ? 'up' : 'down' }} ml-1"></i>@endif
                    </th>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer"
                        ...
                        Rating @if($sortBy === 'rating')<i
                        class="fas fa-sort-{{ $sortOrder === 'asc' ? 'up' : 'down' }} ml-1"></i>@endif
                    </th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Review
                    </th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Reviewer
                    </th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status
                    </th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Helpful
                    </th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer"
                        wire:click="sortByColumn('created_at')">
                        Date @if($sortBy === 'created_at')<i
                        class="fas fa-sort-{{ $sortOrder === 'asc' ? 'up' : 'down' }} ml-1"></i>@endif
                    </th>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                @elseif($review->status == 'pending')
                                    ...
                                    <div class="flex items-center gap-1 mt-1">
                                        @if(auth()->user()->hasPermission('reviews.approve'))
                                        ...
                                        @endif
                                        @if(auth()->user()->hasPermission('reviews.reject'))
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                <button wire:click="viewReview({{ $review->id }})" class="text-blue-600 hover:text-blue-900"
                                    title="View">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-sm text-gray-500">
                        Showing {{ $reviews->firstItem() ?? 0 }} to {{ $reviews->lastItem() ?? 0 }} of
