<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center space-x-3">
            ...
            <button wire:click="toggleEnableQna" type="button"
                ...
                role="switch" aria-checked="{{ $enableQna ? 'true' : 'false' }}">
                <span class="sr-only">Enable Q&A</span>
                <span
                    class="pointer-events-none relative inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out {{ $enableQna ? 'translate-x-5' : 'translate-x-0' }}">
                </span>
            </button>
        </div>
    </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <span class="text-sm text-gray-500">
                            Showing {{ $questions->firstItem() ?? 0 }} to {{ $questions->lastItem() ?? 0 }} of
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: @entangle('showDeleteModal') }">
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="relative rounded-lg shadow-xl max-w-md w-full p-6 border border-gray-200"
                    ...
                    <p class="text-sm text-gray-500 text-center mb-6">Are you sure you want to delete this question and all
                        its answers? This action cannot be undone.</p>
