                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    @if($brand->media || $brand->logo)
                                        <img src="{{ $brand->getThumbnailUrl() }}" alt="{{ $brand->name }}"
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900">
                                    @if($brand->website)
                                        <a href="{{ $brand->getWebsiteUrl() }}" target="_blank"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if(auth()->user()->hasPermission('brands.toggle-status'))
                                    <button wire:click="toggleStatus({{ $brand->id }})" class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors
                                ...
                                @else
                                    <span
                                        class="px-2 py-1 text-xs font-medium rounded-full {{ $brand->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if(auth()->user()->hasPermission('brands.toggle-featured'))
                                    <button wire:click="toggleFeatured({{ $brand->id }})" class="inline-flex items-center">
                                ...
                                @else
                                    <span
                                        class="px-2 py-1 text-xs font-medium rounded-full {{ $brand->is_featured ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800' }}">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <span class="text-sm text-gray-500">
                            Showing {{ $brands->firstItem() ?? 0 }} to {{ $brands->lastItem() ?? 0 }} of
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: @entangle('showDeleteModal') }">
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="relative rounded-lg shadow-xl max-w-md w-full p-6 border border-gray-200"
                    ...
                    <p class="text-sm text-gray-500 text-center mb-6">Are you sure you want to delete this brand? This
