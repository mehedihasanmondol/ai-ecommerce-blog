                    ...
                    @forelse($feedback as $item)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @if($item->is_featured)
                                    <span
                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800 ml-1">Featured</span>
                                @endif
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    @endif
                                    <button wire:click="viewFeedback({{ $item->id }})"
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: @entangle('showDeleteModal') }">
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="relative rounded-lg shadow-xl max-w-md w-full p-6 border border-gray-200"
                    ...
                    <p class="text-sm text-gray-500 text-center mb-6">Are you sure you want to delete this feedback? This
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: @entangle('showViewModal') }" x-show="show" x-cloak
            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                <div class="relative rounded-lg shadow-2xl max-w-3xl w-full border border-gray-200 max-h-[90vh] flex flex-col"
                    ...
                    {{-- Header (Sticky) --}}
                    <div
                        class="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-white rounded-t-lg flex-shrink-0">
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                @endfor
                                <span
                                    class="ml-2 text-sm font-semibold text-gray-700">{{ $selectedFeedback->rating }}/5</span>
                            </div>
                        </div>
                    ...
                    <div class="px-6 py-4 overflow-y-auto flex-1">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 mb-6">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span
                                        class="text-sm font-medium text-gray-900">{{ $selectedFeedback->customer_name }}</span>
                        ...
                        <div class="mb-6">
                            ...
                            @endif
                            <p class="text-gray-700 leading-relaxed whitespace-pre-wrap">{{ $selectedFeedback->feedback }}
                            </p>
                        </div>
                        ...
                        @if($selectedFeedback->images && count($selectedFeedback->images) > 0)
                                ...
                                images: {{ json_encode(array_map(fn($img) => is_array($img) ? asset('storage/' . $img['original']) : asset('storage/' . $img), $selectedFeedback->images)) }}
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        @foreach($selectedFeedback->images as $index => $image)
                                            ...
                                            <div class="group relative aspect-square rounded-lg overflow-hidden border-2 border-gray-200 cursor-pointer hover:border-blue-500 transition-all bg-gray-100"
                                                ...
                                                <img src="{{ asset('storage/' . $imagePath) }}" alt="Feedback Image {{ $index + 1 }}"
                                                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">

                                                <!-- Hover overlay -->
                                                <div
                                                    class="absolute inset-0 bg-black opacity-0 group-hover:opacity-20 transition-opacity pointer-events-none">
                                                </div>
                                                ...
                                                <!-- Image number badge -->
                                                <div
                                                    class="absolute top-2 right-2 bg-white text-gray-900 text-xs font-semibold px-2 py-1 rounded shadow-md">
                                    ...
                                    <!-- Lightbox Modal -->
                                    <div x-show="showLightbox" x-cloak @keydown.escape.window="showLightbox = false"
                                        ...
                                        @click="showLightbox = false" class="fixed inset-0 z-[60] bg-black bg-opacity-95"
                                        style="display: none;">
                                        ...
                                        <div class="h-full flex flex-col items-center justify-center p-4" @click.stop>
                                            ...
                                            <div class="relative w-full max-w-5xl flex items-center justify-center mb-20">
                                                ...
                                                <!-- Previous Button -->
                                                <button
                                                    @click.stop="currentImage = currentImage > 0 ? currentImage - 1 : images.length - 1"
                                                ...
                                                <!-- Image -->
                                                <div class="relative">
                                                    <img :src="images[currentImage]" alt="Feedback Image"
                                                        class="max-w-full max-h-[70vh] object-contain rounded-lg shadow-2xl"
                                                        @click.stop>

                                                    <!-- Image Counter -->
                                                    <div
                                                        class="absolute -bottom-10 left-1/2 transform -translate-x-1/2 bg-white text-gray-900 px-4 py-2 rounded-full text-sm font-medium shadow-lg">
                                                ...
                                                <!-- Next Button -->
                                                <button
                                                    @click.stop="currentImage = currentImage < images.length - 1 ? currentImage + 1 : 0"
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 mb-6">
                            ...
                            <div class="flex items-center gap-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm text-gray-900">{{ $selectedFeedback->helpful_count }}
                                        helpful</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <i class="fas fa-thumbs-down text-red-600"></i>
                                    <span class="text-sm text-gray-900">{{ $selectedFeedback->not_helpful_count }} not
                                        helpful</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center gap-2">
                                    ...
                                    @if($selectedFeedback->is_featured)
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">Featured</span>
                                    @endif
                                </div>
                                <div class="flex items-center gap-2">
                                    <span class="text-sm text-gray-600">Submitted:</span>
                                    <span
                                        class="text-sm text-gray-900">{{ $selectedFeedback->created_at->format('M d, Y h:i A') }}</span>
                                </div>
                                @if($selectedFeedback->approved_at)
                                    <div class="flex items-center gap-2">
                                        <span class="text-sm text-gray-600">Approved:</span>
                                        <span
                                            class="text-sm text-gray-900">{{ $selectedFeedback->approved_at->format('M d, Y h:i A') }}</span>
                    ...
                    @if($selectedFeedback->status == 'pending')
                        <div class="px-6 py-4 border-t border-gray-200 bg-white rounded-b-lg flex-shrink-0">
                            <div class="flex gap-3">
                                @if(auth()->user()->hasPermission('feedback.approve'))
                                    <button wire:click="approve({{ $selectedFeedback->id }})" wire:loading.attr="disabled"
                                        wire:target="approve"
                                    ...
                                    <button wire:click="reject({{ $selectedFeedback->id }})" wire:loading.attr="disabled"
                                        wire:target="reject"
