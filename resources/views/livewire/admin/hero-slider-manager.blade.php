<div
    class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6 overflow-hidden hover:shadow-md transition-shadow duration-200">
    <!-- Enhanced Header -->
        ...
        @else
            <div class="space-y-4" id="sliders-list">
                @foreach($sliders as $slider)
                    <div data-slider-id="{{ $slider->id }}" wire:key="slider-{{ $slider->id }}"
                        ...
                        <!-- Drag Handle -->
                        <div
                            class="drag-handle absolute left-2 top-1/2 -translate-y-1/2 cursor-move opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <div class="mt-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
                <div class="flex items-center text-sm text-purple-800">
                    ...
                    <p><strong>Tip:</strong> Hover over a slider and drag the handle icon to reorder. Changes are saved
                        automatically.</p>
                </div>
            </div>
        @endif
                    ...
                    <form wire:submit.prevent="save" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            @if($editingId && $existingMediaId)
                                ...
                                <div class="mb-3">
                                    @if($existingMedia)
                                        <img src="{{ $existingMedia->large_url ?? $existingMedia->url }}" alt="Current slider image"
                            ...
                            <div wire:ignore>
                                <x-image-uploader target-field="hero_slider_image" :media-id="null" :aspect-ratio="[16, 6]"
                                    :width="1920" :height="720" label="Upload New Slider Image"
                        ...
                        <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
                            ...
                            <button type="submit" wire:loading.attr="disabled" wire:target="save"
                                ...
                                <svg wire:loading wire:target="save" class="animate-spin h-5 w-5 mr-2" fill="none"
                                    viewBox="0 0 24 24">
                                ...
                                <span wire:loading.remove
                                    wire:target="save">{{ $editingId ? 'Update Slider' : 'Create Slider' }}</span>
                ...
                <div class="relative bg-white rounded-2xl shadow-2xl max-w-md w-full" @click.stop>
                    ...
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            <div
                                class="flex-shrink-0 w-12 h-12 rounded-full bg-red-100 flex items-center justify-center mr-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 mt-1">This action cannot be undone. The slider will be
                    ...
                    <div class="flex items-center justify-end space-x-3 px-6 pb-6">
                        ...
                        <button wire:click="deleteSlider" wire:loading.attr="disabled"
