...
<head>
    ...
    <meta name="description"
        content="@yield('description', \App\Models\SiteSetting::get('site_description', 'Shop health, wellness and beauty products'))">
    <meta name="keywords"
        content="@yield('keywords', \App\Models\SiteSetting::get('site_keywords', 'health, wellness, beauty, supplements'))">
    ...
    <meta property="og:description"
        content="@yield('og_description', \App\Models\SiteSetting::get('site_description', 'Shop health, wellness and beauty products'))">
    ...
    <meta name="twitter:description"
        content="@yield('twitter_description', \App\Models\SiteSetting::get('site_description'))">
