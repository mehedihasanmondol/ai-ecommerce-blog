            ...
            <div class="max-w-7xl mx-auto">
                <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                        ...
                        <div class="lg:hidden bg-white rounded-lg shadow-sm mb-6">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <button @click="mobileMenuOpen = !mobileMenuOpen"
                                        ...
                                        <svg class="w-5 h-5 text-gray-600 transition-transform duration-200"
                                            :class="{ 'rotate-90': mobileMenuOpen }" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                            ...
                            <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200"
                                ...
                                <a href="{{ route('customer.orders.index') }}"
                                    ...
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M16 11V7 a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                                    </svg>
                                    My Orders
                                </a>
                    ...
                    <div class="lg:col-span-9 mt-6 lg:mt-0">
                        ...
                        @if(session('success'))
                            <div
                                class="mb-6 bg-green-50 border border-green-200 text-green-800 rounded-lg p-4 flex items-start">
