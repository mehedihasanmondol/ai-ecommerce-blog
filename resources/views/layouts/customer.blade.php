            ...
            <div class="max-w-7xl mx-auto">
                <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                    ...
                    <aside class="lg:col-span-3">
                        ...
                        <button id="mobile-menu-toggle" class="lg:hidden w-full mb-4 px-4 py-3 bg-white rounded-lg shadow-sm flex items-center justify-between text-gray-700 font-medium">
