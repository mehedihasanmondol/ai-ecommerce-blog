...
<footer class="bg-gray-900 text-gray-300">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="flex w-full md:w-auto">
                    <input 
                        ...
                        class="px-4 py-3 w-full md:w-80 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-900"
                    >
                    <button class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-r-lg font-medium transition">
                        Subscribe
                    </button>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Company Info -->
            <div>
                <h4 class="text-white font-bold text-lg mb-4">About Us</h4>
                <p class="text-sm mb-4">Your trusted source for health, wellness, and beauty products. Quality guaranteed.</p>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="hover:text-green-500 transition">Help Center</a></li>
                    <li><a href="{{ route('orders.track') }}" class="hover:text-green-500 transition">Track Order</a></li>
                    <li><a href="#" class="hover:text-green-500 transition">Returns</a></li>
                    <li><a href="#" class="hover:text-green-500 transition">Shipping Info</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-green-500 transition">Cookie Policy</a></li>
                    <li><a href="#" class="hover:text-green-500 transition">Accessibility</a></li>
                </ul>
            </div>
        </div>
    </div>
