...
<div x-data="{ show: false, title: '', message: '', onConfirm: null }" @confirm-modal.window="
        show = true; 
        title = $event.detail.title || 'Confirm Action'; 
        message = $event.detail.message || 'Are you sure?';
        onConfirm = $event.detail.onConfirm;
     " @close-confirm-modal.window="show = false" x-show="show" x-cloak class="fixed inset-0 z-50 overflow-y-auto"
    style="display: none;">
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="relative rounded-lg shadow-2xl max-w-md w-full p-6 border border-gray-200"
            ...
            <div class="flex items-center justify-end space-x-3">
                ...
                <button @click="if(onConfirm) onConfirm();" type="button"
