                        ...
                        @foreach($newArrivalProducts as $newArrival)
                            ...
                            >
                                <div class="flex items-center space-x-4 flex-1">
                                    ...
                                    <!-- Product Image -->
                                    @if($newArrival->product->image_url)
                                        <img 
                                            src="{{ asset('storage/' . $newArrival->product->image_url) }}" 
                                        ...
                                        <div class="flex items-center space-x-3 mt-1">
                                            ...
                                            @if($newArrival->product->sale_price)
                                                <span class="text-sm font-semibold text-green-600">
                                                    ${{ number_format($newArrival->product->sale_price, 2) }}
                                                </span>
                                                <span class="text-sm text-gray-400 line-through">
                                                    ${{ number_format($newArrival->product->price, 2) }}
                                                </span>
                                            @else
