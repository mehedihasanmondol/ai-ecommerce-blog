...
<div class="container-fluid px-4 py-6">
    ...
    <div class="bg-white border-b border-gray-200 -mx-4 -mt-6 px-4 py-3 mb-6 sticky top-16 z-10 shadow-sm">
        <div class="flex items-center justify-between max-w-7xl mx-auto">
            <div class="flex items-center space-x-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900">Edit: {{ $attribute->name }}</h1>
            </div>
    ...
    <div class="max-w-7xl mx-auto">
        <form action="{{ route('admin.attributes.update', $attribute) }}" method="POST" id="attribute-form" x-data="attributeForm()">
        @csrf
        @method('PUT')
