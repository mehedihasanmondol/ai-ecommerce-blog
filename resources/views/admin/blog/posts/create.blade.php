...
/* CKEditor Content Styles - Tailwind Typography Inspired */
.ck-content {
    @apply text-base leading-7 text-gray-700;
}
.ck-content h1 {
    @apply text-4xl font-extrabold text-gray-900 leading-tight mt-0 mb-4;
}
.ck-content h2 {
    @apply text-3xl font-bold text-gray-800 leading-snug mt-6 mb-3;
}
.ck-content h3 {
    @apply text-2xl font-semibold text-gray-700 leading-normal mt-5 mb-2;
}
.ck-content h4 {
    @apply text-xl font-semibold text-gray-600 leading-relaxed mt-4 mb-2;
}
.ck-content p {
...
.ck-content blockquote {
    @apply italic border-l-4 border-gray-300 pl-4 my-6 text-gray-600;
}
/* Force list markers to display (override Tailwind reset) */
.ck-content ul,
.ck-content ol {
    list-style: revert !important; /* Restore browser default list styles */
...
/* Code Blocks - Different styling from inline code */
.ck-content pre[class*="language-"] {
    @apply bg-gray-900 text-gray-100 p-6 rounded-lg overflow-x-auto my-8 font-mono text-sm leading-relaxed;
}
.ck-content pre[class*="language-"] code {
    @apply bg-transparent text-gray-100 p-0;
}

/* Video Embeds */
.ck-content .aspect-w-16 {
    position: relative;
    padding-bottom: 56.25%; /* 16:9 Aspect Ratio */
}
.ck-content .aspect-w-16 iframe {
...
/* List Style Types with Tailwind */
.ck-content ul[style*="list-style-type: disc"],
.ck-content ul:not([style*="list-style-type"]) {
    @apply list-disc pl-6 my-4 space-y-2;
}
.ck-content ul[style*="list-style-type: circle"] {
...
.ck-content ol:not([style*="list-style-type"]) {
...
/* Blockquote Enhanced */
.ck-content blockquote {
    @apply italic border-l-4 border-blue-400 bg-blue-50 pl-6 pr-4 py-4 my-6 text-gray-700 rounded-r-lg;
}
...
/* Font Families */
.ck-content .font-sans {
    @apply font-sans;
}
.ck-content .font-serif {
    @apply font-serif;
}
.ck-content .font-mono {
    @apply font-mono;
}
</style>
@endpush
