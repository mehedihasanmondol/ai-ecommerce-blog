...
@section('content')
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white rounded-lg shadow">
                            ...
                            <div class="px-6 py-3 border-t border-gray-100">
                                <div class="flex items-center text-sm">
                                    ...
                                    <button type="button" onclick="editSlug()"
                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <textarea name="content" id="ckeditor" class="ckeditor-content">{{ old('content') }}</textarea>
                        ...
                        <div class="bg-white rounded-lg shadow" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition class="px-6 pb-6 border-t border-gray-100">
                                ...
                                <p class="mt-2 text-xs text-gray-500">Excerpts are optional hand-crafted summaries of your
                                    content.</p>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <div class="space-y-4">
                                    ...
                                    @if(auth()->user()->hasPermission('posts.publish'))
                                        <select name="status" required
                                            ...
                                            <option value="scheduled" {{ old('status') == 'scheduled' ? 'selected' : '' }}>
                                                Scheduled</option>
                                            <option value="unlisted" {{ old('status') == 'unlisted' ? 'selected' : '' }}>Unlisted
                                            </option>
                                        </select>
                                        <p class="mt-1 text-xs text-gray-500">
                                            <strong>Unlisted:</strong> Post is viewable via direct link but won't appear in any
                                            frontend lists
                                        </p>
                                    @else
                                        ...
                                        <p class="mt-1 text-xs text-gray-500">You don't have permission to change post status
                                        </p>
                                    @endif
                                </div>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                ...
                                <div x-show="expanded" x-collapse class="px-6 pb-6 border-t border-gray-100">
                                    <div class="space-y-3 pt-4">
                                        <div class="flex items-start">
                                            <input type="checkbox" name="is_verified" value="1" {{ old('is_verified') ? 'checked' : '' }} id="is_verified"
                                                class="mt-1 w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                            <div class="ml-3">
                                                <label for="is_verified"
                                                    class="text-sm font-medium text-gray-700 flex items-center">
                                                    <span
                                                        class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 mr-2">
                                                ...
                                                <p class="text-xs text-gray-500 mt-1">Mark this post as fact-checked and
                                                    verified</p>
                                            </div>
                                        </div>

                                        <div class="flex items-start">
                                            <input type="checkbox" name="is_editor_choice" value="1" {{ old('is_editor_choice') ? 'checked' : '' }} id="is_editor_choice"
                                                class="mt-1 w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500">
                                            <div class="ml-3">
                                                <label for="is_editor_choice"
                                                    class="text-sm font-medium text-gray-700 flex items-center">
                                                    <span
                                                        class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800 mr-2">
                                                        <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                            <path
                                        ...
                                        <div class="flex items-start">
                                            <input type="checkbox" name="is_trending" value="1" {{ old('is_trending') ? 'checked' : '' }} id="is_trending"
                                        ...
                                        <div class="flex items-start">
                                            <input type="checkbox" name="is_premium" value="1" {{ old('is_premium') ? 'checked' : '' }} id="is_premium"
                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <input type="url" name="youtube_url" id="youtube_url" value="{{ old('youtube_url') }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                                placeholder="https://www.youtube.com/watch?v=..." onchange="previewYouTubeVideo(this.value)"
                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <p class="text-sm text-gray-600 mb-3">Select one or more categories (hierarchical structure
                                shown)</p>
                            ...
                            <div class="space-y-1 max-h-64 overflow-y-auto border border-gray-200 rounded-lg p-3"
                                ...
                                @forelse($categories as $category)
                                    <label class="flex items-start hover:bg-gray-50 p-2 rounded cursor-pointer group">
                                        ...
                                        <div class="ml-2 flex-1">
                                            <span
                                                class="text-sm text-gray-700">{{ $category->dropdown_label ?? $category->name }}</span>
                                ...
                                @empty
                                    <p class="text-sm text-gray-500 text-center py-4">No categories available. Click "Add New"
                                        to create one.</p>
                                @endforelse
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <div class="space-y-2 max-h-48 overflow-y-auto border border-gray-200 rounded-lg p-3"
                                ...
                                @empty
                                    <p class="text-sm text-gray-500 text-center py-4">No tags available. Click "Add New" to
                                        create one.</p>
                                @endforelse
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow p-6" x-data="{ 
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <button type="button" @click="showProducts = !showProducts"
                                    ...
                                    <svg class="w-4 h-4 transform transition-transform"
                                        :class="showProducts ? 'rotate-180' : ''" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M19 9l-7 7-7-7" />
                                    </svg>
                            ...
                            <p class="text-sm text-gray-600 mb-3">Select products to feature in this article (optional).
                                Products will appear in "Shop This Article" section.</p>

                            <!-- Search Box -->
                            <div x-show="showProducts" x-collapse class="mb-3">
                                <input type="text" x-ref="productSearch" @input="filterProducts($event.target.value)"
                                    placeholder="Search products by name..."
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                            </div>

                            <!-- Product Selection -->
                            <div x-show="showProducts" x-collapse
                                class="space-y-2 max-h-96 overflow-y-auto border border-gray-200 rounded-lg p-3"
                                ...
                                @forelse($products as $product)
                                    <label class="flex items-center hover:bg-gray-50 p-2 rounded cursor-pointer">
                                        ...
                                        @if($product->getPrimaryThumbnailUrl())
                                            <img src="{{ $product->getPrimaryThumbnailUrl() }}" alt="{{ $product->name }}"
                            ...
                            <p class="text-xs text-gray-500 mt-2">
                                <svg class="w-4 h-4 inline text-blue-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                Tip: Products will be displayed in the order you select them. You can reorder by unchecking
                                and rechecking.
                            </p>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <a href="{{ route('admin.blog.posts.index') }}"
                                class="block w-full text-center bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-3 px-4 rounded-lg mt-2 transition duration-150">
                                Cancel
                            </a>
                        </div>
                    </div>
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            ...
            <div class="relative rounded-lg shadow-xl max-w-lg w-full border border-gray-200"
                ...
                <div class="bg-white px-6 pt-5 pb-4 rounded-t-lg">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="modal-category-description" rows="3"
                ...
                <div class="bg-gray-50 px-6 py-3 flex items-center justify-end gap-3 rounded-b-lg">
                    ...
                    <button type="button" onclick="createCategoryFromModal()" id="create-category-btn"
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            ...
            <div class="relative rounded-lg shadow-xl max-w-lg w-full border border-gray-200"
                ...
                <div class="bg-white px-6 pt-5 pb-4 rounded-t-lg">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="modal-tag-description" rows="3"
                ...
                <div class="bg-gray-50 px-6 py-3 flex items-center justify-end gap-3 rounded-b-lg">
                    ...
                    <button type="button" onclick="createTagFromModal()" id="create-tag-btn"
    ...
    @push('scripts')
        <script>
            ...
            window.canUploadImages = {{ auth()->user()->hasPermission('posts.upload-image') ? 'true' : 'false' }};
        </script>

        @vite('resources/js/blog-post-editor.js')
        <script>
                                            // Mo    dal Functions
                                            funct        ion openCategoryModal() {
