...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'admin.access'])->group(function () {
    ...
    Route::prefix('blog')->name('blog.')->group(function () {
        ...
        // Headline Banner Settings - Requires headline-banner.view permission
        Route::middleware(['permission:headline-banner.view'])->group(function () {
            Route::get('headline-banner', [\App\Http\Controllers\Admin\HeadlineBannerController::class, 'index'])
                ->name('headline-banner.index');

            Route::middleware(['permission:headline-banner.edit'])->group(function () {
                Route::put('headline-banner', [\App\Http\Controllers\Admin\HeadlineBannerController::class, 'update'])
                    ->name('headline-banner.update');
                Route::post('headline-banner/toggle', [\App\Http\Controllers\Admin\HeadlineBannerController::class, 'toggle'])
                    ->name('headline-banner.toggle');
            });
        });
    });
});
